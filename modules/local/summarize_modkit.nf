 ...
 *
 * Output columns: assay_id, mean_meth, n_cpgs, median_cov
 *
 * These map to modkit_mean_meth / modkit_n_cpgs / modkit_median_cov after
 * casetrack's --column-prefix rename. The TSV filename matches
...
process SUMMARIZE_MODKIT {
    ...
    stub:
    """
    printf 'assay_id\\tmean_meth\\tn_cpgs\\tmedian_cov\\n' > modkit_summary.tsv
    printf '%s\\t0.7200\\t1500\\t18\\n' '${meta.assay_id}' >> modkit_summary.tsv
    """
}
